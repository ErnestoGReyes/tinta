// Mismo set base que Plano (para que compartir componentes de nav/común no
// rompa nada) + los íconos nuevos que Tinta necesita: Book, Chapter, Timeline,
// MapPin, Goal, Quill.
export const Icons = {
  Editor: (props) => (
  ...
  Timeline: (props) => (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <line x1="2" y1="12" x2="22" y2="12"/><circle cx="6" cy="12" r="2.2" fill="currentColor" stroke="none"/><circle cx="13" cy="12" r="2.2" fill="currentColor" stroke="none"/><circle cx="20" cy="12" r="2.2" fill="currentColor" stroke="none"/>
    </svg>
  ),
  Map: (props) => (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
